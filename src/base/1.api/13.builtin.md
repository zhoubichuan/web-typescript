...
const student:Readonly<PersonType> = {
    name:'xiaoming',
    age:'14',
}

const body:Readonly<PersonType> = {
    name:'xiaoming',
}
```
...
// type PickPersonType = Pick<Person, "name" | "age">;
// {
//   name: string;
//   age: string;
// }
...
const student:Pick<PersonType, "name" | "age"> = {
    name:'xiaoming',
    age:'14',
}

const body:Pick<PersonType, "name"> = {
    name:'xiaoming',
}
```
...
// type RecordersonType = Record<string, number>;
// {
//   age: number;
//   phone: number;
// }
...
// type OmitPersonType = Omit<PersonType,'phone'>;
// {
//   name: string;
//   age: string;
// }
...
const student:Omit<PersonType,'phone'> = {
    name:'xiaoming',
    age:'14',
}
```
